...
export default function Contact(){
  ...
  const handleClick = (buttonName:any) => {
    ...
    return(
        <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2e0249] lg:rounded-lg md:rounded-lg">
            <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    ...
                    <ul className="flex mt-12 space-x-4">
                        <li className="bg-[#E4599C] hover:bg-[#E4599Ce2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
      ...
      <button
        ...
        className={`px-4 py-2 rounded-lg ${
          activeButton === 'web-design' ? 'bg-[#E4599C] text-white' : 'bg-transparent text-gray-800'
        } hover:bg-[#E4599C] hover:text-white text-sm tracking-wider font-medium outline-none border-2 mr-4`}
      ...
      <button
        type="button"
        className={`px-4 py-2 rounded-lg ${
          activeButton === 'graphic-design' ? 'bg-[#E4599C] text-white' : 'bg-transparent text-gray-800'
        } hover:bg-[#E4599C] hover:text-white text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4`}
      ...
      <button
        type="button"
        className={`px-4 py-2 rounded-lg ${
          activeButton === 'design-system' ? 'bg-[#E4599C] text-white' : 'bg-transparent text-gray-800'
        } hover:bg-[#E4599C] hover:text-white text-sm tracking-wider font-medium outline-none border-2 border-gray-300`}
        ...
        General Feedback
                    ...
                    <form className="mt-8 space-y-4">
                        <input type='text' placeholder='Name'
                            className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#E4599C]" />
                        <input type='email' placeholder='Email'
                            className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#E4599C]" />
                        <input type='text' placeholder='Subject'
                            className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#E4599C]" />
                        <textarea placeholder='Message' rows={6}
                            className="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#E4599C]"></textarea>
                        <button type='submit'
                            className="text-white bg-[#E4599C] hover:bg-[#E4599Ce2] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
