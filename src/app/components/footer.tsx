...
export default function Footer (){
    ...
    return(
        <footer className="font-sans tracking-wide bg-[#27282b] py-12 px-8 mt-[2%] text-black bg-yellow-200">
      <div className="max-w-6xl max-lg:max-w-screen-md mx-auto">
        <div className="grid max-md-grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            ...
            <div className="text-sm mt-6  leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean gravida,
              mi eu pulvinar cursus, sem elit interdum mauris dipiscing elit. Aenean gravida,
              mi eu pulvinar cursus 
              {!isExpanded && (
                <span>
                <p className="inline">...</p><a href='javascript:void(0)' className="text-sm font-semibold  toggle" 
                aria-expanded={isExpanded} onClick={handleClick}>Read
                more</a> 
                </span>
              )}
              {isExpanded && (
                <p className="inline">
                cumque modi adipisci quis, repellendus a at eos, et quos voluptatum autem mollitia dolores harum,
                ea veniam nihil. Doloremque, dolore neque.</p>
            ...
            <ul className="grid sm:grid-cols-2 mt-12 gap-2">
              <li className="flex items-center max-sm:mb-8">
                <div className="bg-[#E4599C] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
          ...
          <div>
            ...
            <form className="bg-[#ffffff] flex px-2 py-1 rounded-full mt-12 ">
              <input type='email' placeholder='Enter your email'
                className="w-full outline-none text-sm bg-transparent pl-4" />
              <button type='submit'
                className="bg-[#E4599C] hover:bg-opacity-[0.5]  transition-all  font-semibold text-sm rounded-full px-5 py-2 ml-4">Submit</button>
            </form>

            <ul className="flex items-center justify-end mt-8 space-x-4">
              <li className="bg-[#E4599C] h-10 w-10 rounded-full flex items-center justify-center shrink-0 ">
              ...
              <li className="bg-[#E4599C] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a href="javascript:void(0)">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" className="fill-gray-300" viewBox="0 0 511 512">
                    <path
              ...
              <li className="bg-[#E4599C] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a href="javascript:void(0)">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" className="fill-gray-300"
                    ...
                    <g fill="none" stroke="#d1d5db" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
        ...
        <div className="lg:flex lg:item-center mt-12">
          <ul className="flex flex-wrap gap-4">
            <li>
              <a href='javascript:void(0)' className=' hover:text-[#E4599C] text-sm'>Terms of Service</a>
            </li>
            <li>
              <a href='javascript:void(0)' className=' hover:text-[#E4599C] text-sm'>Privacy Policy</a>
            </li>
            <li>
              <a href='javascript:void(0)' className=' hover:text-[#E4599C] text-sm'>Security</a>
            </li>
          </ul>

          <p className='text-sm  lg:ml-auto max-lg:mt-6'>© GourmetDiaries. All rights reserved.</p>
        </div>
      </div>
    </footer>
    )
